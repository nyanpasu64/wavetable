...
import numpy as np
from wavetable.dsp.fourier import zero_space, rfft_norm, irfft_norm, rfft_zoh, irfft_zoh, \
...
def test_repeat():
    ...
    pad = zero_space(rfft_zoh(pulse), 3)
